                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <div class="btn-group btn-group-sm">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li>
                                                                            <button class="dropdown-item" onclick="marcarContacto(<%= contacto.getIdContacto() %>, 'pendiente')">
                                                                                <i class="bi bi-clock text-warning me-2"></i>Pendiente
                                                                            </button>
                                                                        </li>
                                                                        <li>
                                                                            <button class="dropdown-item" onclick="marcarContacto(<%= contacto.getIdContacto() %>, 'respondido')">
